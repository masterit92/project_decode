...
return array(
    ...
    'updated fail!'=>'Cập nhật không thành công!',
    'deviation time(minutes)'=>'Lệch với khung giờ chính (phút)',
    'deviation time is number int'=>'Lệch khung giờ phải là số nguyên',
    're-password'=>'Nhập lại mật khẩu',
    'changer'=>'Thay Đổi',
    'changer password'=>'Thay đổi mật khẩu',
    're-password not empty'=>'Nhập lại mật khẩu phải nhập.',
    'password and re-password is same'=>'Mật khẩu mới và mật khẩu nhập lại phải giống nhau.',
    'Update fail'=>'Cập nhật thất bại',
    'new-password'=>'Mật khẩu mới.',
    'new-password not empty'=>'Mật khảu mới không được để trống',
